...
### Содержание: / Content:
  ...
  - [Предобработка данных / Data Processing - *Project_01*](01_research_on_borrower_reliability.ipynb)
...
|13  |[(Дипломный проект)](13_graduate_project_)|Чтобы оптимизировать производственные расходы, металлургический комбинат ООО «Так закаляем сталь» решил уменьшить потребление электроэнергии на этапе обработки стали. В проекте построена модель, которая предсказывает температуру стали.|`catboost` `sklearn` `seaborn` `matplotlib` `plotly` `pandas` `numpy` `math`|

## Contacts

- email: chertache@gmail.com | telegram: @chertac
